...
const postTemplates = [
  {
    ...
    content:
      "Just finished implementing a complex state management solution using Redux Toolkit. The type safety and developer experience improvements are incredible! Here's what I learned along the way...",
    image:
  ...
  },
  {
    ...
    content:
      "After working with both for years, I've developed some clear guidelines for when to choose CSS Grid over Flexbox and vice versa. The key is understanding their different strengths.",
  },
  {
    title: "My Journey Learning Next.js",
    content:
      "Started my Next.js journey last month and I'm already in love with the framework. The file-based routing and built-in optimizations make development so much smoother.",
    image:
  ...
  },
  {
    ...
    content:
      "Working on a large-scale application taught me the importance of proper database design. Here are the key principles I follow for scalable database architecture.",
  },
  {
    title: "The Future of Web Development",
    content:
      "With the rapid evolution of web technologies, it's exciting to think about what's coming next. Edge computing, WebAssembly, and AI integration are changing everything.",
    image:
      "https://images.pexels.com/photos/1181675/pexels-photo-1181675.jpeg?auto=compress&cs=tinysrgb&w=800",
  },
];

export const generateDummyUser = (id: string): any => {
  if (id === "current-user") {
    return {
      id: "current-user",
      name: "You",
